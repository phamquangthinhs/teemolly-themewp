    ...
    <div class="tm10">
        <div class="container">
            <div class="row">
                ...
                <!--                end tin chinh-->
                <div class="col-lg-4 col-md-4 col-sm-10 col-lg-offset-0 col-md-offset-0 col-sm-offset-1">
                    <div class="tn4">
                        <?php 
                          global $post;
        ...
        <div class="container">
            <div class="row">
              ...
              foreach($custom_posts as $post) : setup_postdata($post); ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 tn2">
                    <div class="row">
    ...
    <div class="tm12">
        <div class="container">
            <div class="row">
              ...
              $custom_posts = get_posts ($args);
              foreach($custom_posts as $post) : setup_postdata($post); ?>
                <div class="col-lg-4 col-md-4 col-sm-10 col-lg-offset-0 col-md-offset-0 col-sm-offset-1 tn2">
                    <div class="tn1">
